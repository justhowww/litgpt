...
def parse_nal(
    ...
    *,
    ...
    try:
        ...
        # On an invalid bitstream (e.g. the model's free-run output) parsing can
        # fail many ways, all meaning "desync, not crash": ValueError = CAVLC
        # VLC-table miss; KeyError/IndexError = an out-of-range syntax value used
        # as a table key (e.g. sub_mb_type=7 -> _SUB_MB_NUM_PARTS[7]). Report the
