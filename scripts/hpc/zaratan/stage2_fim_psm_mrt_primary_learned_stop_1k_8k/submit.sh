#!/bin/bash
# Launch MRT-primary learned stopping with no supervised EOS labels.
...
export MODEL_NAME=${MODEL_NAME:-byte-stage2-fim-psm-mrt-primary-learned-stop-1k-8k}
export OUT_DIR=${OUT_DIR:-"${STAGED_CORPUS}/runs/byte-stage2-fim-psm-mrt-primary-learned-stop-1k-8k"}
