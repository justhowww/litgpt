#!/bin/bash
# Speed Pilot 3: test whether microbatch=4 further improves utilization while
# keeping global batch=64 and activation checkpointing enabled.
...
export MODEL_TAG=${MODEL_TAG:-byte-jpeglm-7b-megabyte-patch8-gop-guard0-speed-microbatch4}
