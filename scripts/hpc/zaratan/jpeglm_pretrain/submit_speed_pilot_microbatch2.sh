#!/bin/bash
# Speed Pilot 2: test whether microbatch=2 improves utilization while keeping
# global batch=64. Activation checkpointing remains enabled for memory safety.
...
export MODEL_TAG=${MODEL_TAG:-byte-jpeglm-7b-megabyte-patch8-gop-guard0-speed-microbatch2}
