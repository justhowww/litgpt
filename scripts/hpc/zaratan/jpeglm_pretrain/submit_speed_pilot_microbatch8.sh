#!/bin/bash
# Speed Pilot 4: test whether microbatch=8 further improves utilization while
...
export MODEL_TAG=${MODEL_TAG:-byte-jpeglm-7b-megabyte-patch8-gop-guard0-speed-microbatch8}
