#!/bin/bash
# Speed Pilot 1: isolate the runtime and memory effect of disabling activation
# checkpointing. All data/model/batch settings match the compiled baseline pilot.
...
export MODEL_TAG=${MODEL_TAG:-byte-jpeglm-7b-megabyte-patch8-gop-guard0-speed-no-activation-checkpointing}
