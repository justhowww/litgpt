#!/bin/bash
# Phase 1 -- small AVC-LM reproduction on UMD Vulcan (2x a6000, FSDP). ~1000 videos,
...
# resumable. 2 GPUs shard the 85M @ 16384 model to fit 24 GB a6000s. SLURM placement is in
...
echo "[phase1-repro/vulcan] ${MAX_ROWS} videos / ~85M (${N_LAYER}/${N_EMBD}/${N_HEAD}) / ${DEVICES}x a6000 / no_encoding=${NO_ENCODING} / steps=${STEPS}"
